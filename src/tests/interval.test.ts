...
describe("Interval class testing", () => {
  ...
  test("Major Interval validity", () => {
    expect(Interval.fromString("M10").isValid()).toBeFalsy();
  ...
  test("Minor interval validity", () => {
    expect(Interval.fromString("M15").isValid()).toBeFalsy();
  ...
  test("Perfect interval validity", () => {
    expect(Interval.fromString("P25").isValid()).toBeFalsy();
  ...
  test("Augumented interval validity", () => {
    expect(Interval.fromString("A25").isValid()).toBeFalsy();
  ...
  test("Diminished interval validity", () => {
    ...
    expect(Interval.fromString("d7").isValid()).toBeFalsy();
